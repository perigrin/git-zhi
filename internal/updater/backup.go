// ABOUTME: Backup creation and management for binary updates.
// ABOUTME: Handles timestamped backups with SHA256 metadata and cleanup.
...
func (bm *BackupManager) getBackupDir() (string, error) {
	...
	if err != nil {
		...
		return filepath.Join(os.TempDir(), "git-zhi-backups"), nil
	}

	return filepath.Join(cacheDir, "git-zhi", "backups"), nil
}

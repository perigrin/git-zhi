// ABOUTME: HTTP file downloader with progress tracking and checksum validation.
// ABOUTME: Supports resume, retry with backoff, and SHA256 integrity verification.

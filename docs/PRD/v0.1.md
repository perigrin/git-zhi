---
title: git-zhi PRD v0.1
tags: ["projects", "ideas"]
description: "Product requirements document for git-zhi v0.1 — core task graph with dependency scheduling and telemetry"
---

# git-zhi v0.1 — Core: Product Requirements Document
